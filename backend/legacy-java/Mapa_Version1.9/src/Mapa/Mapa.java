...
public class Mapa extends JPanel {
    ...
    public Mapa(List<Nodo> nodos, List<Edge> bordes) {
        this.nodos = nodos;
        this.bordes = bordes;
        ...
        addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (panning) {
                    ...
                    prevMouseX = e.getX();
                    prevMouseY = e.getY();
                    actualizarAreaVisible(panX, panY);
                    repaint();
                }
            }
        });
        ...
        JButton BotonReset = new JButton("Reiniciar");
        BotonReset.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		reiniciarMapa();
        	}
        });
        BotonReset.setFont(new Font("Arial Black", Font.PLAIN, 17));
        BotonReset.setBounds(291, 10, 133, 39);
        add(BotonReset);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Edge borde : bordes) {
            ...
            if (nodoFuente != null && nodoDestino != null) {
                int x1 = nodoFuente.getX();
                int y1 = nodoFuente.getY();
    ...
    private void actualizarAreaVisible(int panX2, int panY2) {
        int width = getWidth();
        int height = getHeight();

        visibleArea = new Rectangle(
            0-panX2, 0-panY2,              
            (int)(width / zoom)-panX2,
            (int)(height / zoom)-panY2
        );
    }
    ...
    public Nodo encontrarNodoMasCercano(double mouseX, double mouseY) {
        ...
        double distanciaMinima = 100; // Inicializar con un valor grande
    ...
    public void setZoom(double zoom) {
        this.zoom = zoom;
        actualizarAreaVisible(panX, panX);
        repaint();
    }
